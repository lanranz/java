...
public class HttpServerJson {
  ...
  private static void processData(OutputStream outputStream, Request request) throws IOException {
    ...
    switch (url) {
      ...
      case "/server/user/list": {
        ...
        sendJsonResponse(outputStream, userList);
      }
      break;
  ...
  private static void sendJsonResponse(OutputStream outputStream, Object object)
      throws IOException {
  ...
  private static void sendOk(OutputStream outputStream)
      throws IOException {
    outputStream.write("HTTP/1.1 200 OK\n".getBytes());
    outputStream.write("\n".getBytes());
  }
